...
function MyTabs({ tableType }: { tableType: string }) {
    return (
        <Tab.Group>
            ...
            <Tab.Panels className="pt-16">
                <Tab.Panel>
                    <BrandList tableType={tableType} />
                </Tab.Panel>
                <Tab.Panel>
                    <ShopList tableType={tableType} />
                </Tab.Panel>
            </Tab.Panels>
        </Tab.Group>
    );
...
const Page = ({
    ...
    return (
        <div className="flex flex-col py-8 mx-auto">
            <div className="text-5xl font-bold mx-auto pb-8">{tableName}</div>
            <div className="relative flex align-center justify-center w-full">
                <MyTabs tableType={tableName} />
            </div>
        </div>
    );
};
