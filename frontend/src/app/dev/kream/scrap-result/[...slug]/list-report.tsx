...
import { insertListScrapToDB } from "../../fetch";
...
export default function ScrapResult({ fetchData }: { fetchData: any }) {
    ...
    const handleDB = async (platformType: string, scrapTime: string) => {
        await insertListScrapToDB(platformType, scrapTime).then((res) => {
            if (res.status === 200) {
        ...
        <div className="flex flex-col gap-4 max-w-3xl mx-auto">
            ...
            <div className="flex gap-4 w-full text-lg py-8">
                ...
                <button
                    ...
                    onClick={() => handleDB(scrapLog[0].platform_type, scrapTime)}
                    disabled={dbUpdate}>
                    {" "}
