...
export const handleRestartListSubmit = async (
    state: scrapingProps,
...
export default function PlatformList() {
    ...
    const [scrapName, setName] = useState("");
    ...
    useEffect(() => {
        if (scrapName === "") return;
        router.push(`/dev/kream/scrap-result/list/${scrapName}-kream`);
    }, [scrapName, router]);
    ...
    return (
        <div className="flex gap-8 justify-between">
            ...
            <button
                ...
                onClick={() => handleRestartListSubmit(state, setName, enableButton, disableButton)}>
                요청하기
            </button>
        </div>
    );
