...
class Currency:
    ...
    def __init__(
        ...
        if buy_dir and custom_dir:
            ...
            path = config.get("SHOP_CURRENCY_DIR")
            assert path, "SHOP_CURRENCY_DIR is not set"
    ...
    def _get_buying_currency_from_API(self) -> None:
        ...
        for i in range(1, 6):
            ...
            params = {
                "authkey": config.get("SHOP_BUYING_CURRENCY_API_KEY"),
    ...
    def _get_custom_currency_from_API(self) -> None:
        ...
        """
        params = {
            "serviceKey": config.get("SHOP_CUSTOM_CURRENCY_APY_KEY"),
